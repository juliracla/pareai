      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {list.map((item, idx) => (
            <div 
              key={idx} 
              className={`reveal reveal-delay-${idx + 1} p-8 rounded-3xl border border-slate-800 bg-[#111821]/50 hover:border-[#0ed90e]/50 transition-all group text-left`}
            >
              ...
              <h3 className="text-xl font-bold mb-3 text-white uppercase italic">{item.title}</h3>
