        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="flex flex-col gap-10 order-2 lg:order-1">
            ...
            <div className="inline-flex items-center gap-2 w-fit">
              <div className="w-6 h-6 rounded-full border-2 border-[#0ed90e] flex items-center justify-center">
                <div className="w-2.5 h-2.5 rounded-full bg-[#0ed90e]" />
              </div>
              <span className="text-xs font-black text-[#0ed90e] uppercase tracking-[0.3em]">PareAi</span>
            </div>

            {/* Main heading — Live N Move style: large, line-broken, bold */}
            <h1 className="font-black uppercase leading-[0.85] tracking-tighter">
              <span className="block text-7xl lg:text-9xl xl:text-[8.5rem] text-white">Mercar</span>
              <span className="block text-7xl lg:text-9xl xl:text-[8.5rem] text-white">sin</span>
              <span className="block text-7xl lg:text-9xl xl:text-[8.5rem] text-[#0ed90e]">Estrés.</span>
            </h1>

            {/* Subtitle */}
            <p className="text-lg lg:text-xl text-slate-400 max-w-xl leading-relaxed font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              <a
                href="#download"
                className="group inline-flex items-center gap-3 bg-[#0ed90e] text-[#111821] px-10 py-5 font-black uppercase tracking-[0.15em] text-base rounded-full transition-all hover:scale-105 active:scale-95 shadow-[0_20px_50px_-10px_rgba(14,217,14,0.5)]"
              >
                Descargar App
              ...
              <a
                href="#features"
                className="inline-flex items-center gap-2 text-white/60 hover:text-white text-base font-black uppercase tracking-[0.15em] transition-colors py-5"
              >
                Ver más
              </a>
            </div>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-white/8">
              <span className="text-sm text-[#0ed90e] font-black uppercase tracking-widest">Siguenos en:</span>
          ...
          <div className="flex justify-center lg:justify-end items-center">
            <NextImage 
              ...
              width={800}
              height={800}
              className="w-80 h-80 sm:w-[500px] sm:h-[500px] lg:w-[700px] lg:h-[700px] xl:w-[800px] xl:h-[800px] object-contain"
